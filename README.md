...
2. Open the *avr128da48-cnano-adc-free-running.X* project in MPLAB® X IDE.

3. Set *avr128da48-cnano-adc-free-running.X* project as main project. Right click on the project in the *Projects* tab and click *Set as Main Project*:
