...
# AVR128DA48 ADC Free Running Conversions

## Objective

In this application, the ADC will continuously perform conversions.
...
2. Open the *avr128da48-cnano-adc-free-running-mplab.X* project in MPLAB® X IDE.

3. Set *avr128da48-cnano-adc-free-running-mplab.X* project as main project. Right click on the project in the *Projects* tab and click *Set as Main Project*:
...
This application showcases the free running feature of the ADC. 